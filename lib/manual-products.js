import manualCatalogData from '../data/manual-products.js';
...
export function countManualDrafts() {
  return (manualCatalogData.products || []).filter((product) => product.published === false).length;
}
